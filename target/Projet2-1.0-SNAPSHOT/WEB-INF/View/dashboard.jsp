        ...
        <div class="col l4 s6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>
                <%
                  Object nbMembres = request.getAttribute("nombreMembre");
                  out.println( nbMembres );
                %>
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3>
                <%
                  Object nbLivres = request.getAttribute("nombreLivre");
                  out.println( nbLivres);
                %>
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>
                <%
                  Object nbEmprunts = request.getAttribute("nombreEmprunt");
                  out.println( nbEmprunts );
                %>
              </h3> <!-- TODO : afficher le nombre d'emprunts à la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
                ...
                <tbody id="results">
                    ...
                    <c:forEach items = "${listeEmprunts}" var ="emprunt">
                      <tr>
                        ...
                        <td><c:out value="${emprunt.getMembre().getPrenom()}"></c:out>, <c:out value="${emprunt.getMembre().getNom()}"></c:out></td>
